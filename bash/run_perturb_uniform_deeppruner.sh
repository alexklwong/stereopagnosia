...
--output_path perturb_models/deeppruner/uniform/both_norm2e2 \
--device gpu
...
--stereo_method deeppruner \
--stereo_model_restore_path pretrained_models/DeepPruner/DeepPruner-best-kitti.tar \
--output_path perturb_models/deeppruner/uniform/both_norm1e2 \
--device gpu
...
--stereo_method deeppruner \
--stereo_model_restore_path pretrained_models/DeepPruner/DeepPruner-best-kitti.tar \
--output_path perturb_models/deeppruner/uniform/both_norm5e3 \
--device gpu
...
--stereo_method deeppruner \
--stereo_model_restore_path pretrained_models/DeepPruner/DeepPruner-best-kitti.tar \
--output_path perturb_models/deeppruner/uniform/both_norm2e3 \
--device gpu
