...
--output_path perturb_models/aanet/uniform/both_norm2e2 \
--device gpu
...
--stereo_method aanet \
--stereo_model_restore_path pretrained_models/AANet/aanet_kitti15-fb2a0d23.pth \
--output_path perturb_models/aanet/uniform/both_norm1e2 \
--device gpu
...
--stereo_method aanet \
--stereo_model_restore_path pretrained_models/AANet/aanet_kitti15-fb2a0d23.pth \
--output_path perturb_models/aanet/uniform/both_norm5e3 \
--device gpu
...
--stereo_method aanet \
--stereo_model_restore_path pretrained_models/AANet/aanet_kitti15-fb2a0d23.pth \
--output_path perturb_models/aanet/uniform/both_norm2e3 \
--device gpu
