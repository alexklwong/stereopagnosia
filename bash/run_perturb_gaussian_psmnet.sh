...
--output_path perturb_models/psmnet/gaussian/both_norm2e2 \
--device gpu
...
--stereo_method psmnet \
--stereo_model_restore_path pretrained_models/PSMNet/pretrained_model_KITTI2015.tar \
--output_path perturb_models/psmnet/gaussian/both_norm1e2 \
--device gpu
...
--stereo_method psmnet \
--stereo_model_restore_path pretrained_models/PSMNet/pretrained_model_KITTI2015.tar \
--output_path perturb_models/psmnet/gaussian/both_norm5e3 \
--device gpu
...
--stereo_method psmnet \
--stereo_model_restore_path pretrained_models/PSMNet/pretrained_model_KITTI2015.tar \
--output_path perturb_models/psmnet/gaussian/both_norm2e3 \
--device gpu
