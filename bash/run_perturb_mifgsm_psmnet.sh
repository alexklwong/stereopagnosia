...
--output_path perturb_models/psmnet/mifgsm/both_norm2e2_lr2e3_mu9e1 \
--device gpu
...
--stereo_method psmnet \
--stereo_model_restore_path pretrained_models/PSMNet/pretrained_model_KITTI2015.tar \
--output_path perturb_models/psmnet/mifgsm/both_norm1e2_lr25e4_mu9e1 \
--device gpu
...
--stereo_method psmnet \
--stereo_model_restore_path pretrained_models/PSMNet/pretrained_model_KITTI2015.tar \
--output_path perturb_models/psmnet/mifgsm/both_norm5e3_lr125e4_mu9e1 \
--device gpu
...
--stereo_method psmnet \
--stereo_model_restore_path pretrained_models/PSMNet/pretrained_model_KITTI2015.tar \
--output_path perturb_models/psmnet/mifgsm/both_norm2e3_lr5e5_mu9e1 \
--device gpu