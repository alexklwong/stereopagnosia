...
--output_path perturb_models/deeppruner/di2fgsm/both_norm2e2_lr2e3_di5e1 \
--device gpu
...
--stereo_method deeppruner \
--stereo_model_restore_path pretrained_models/DeepPruner/DeepPruner-best-kitti.tar \
--output_path perturb_models/deeppruner/di2fgsm/both_norm1e2_lr25e4_di5e1 \
--device gpu
...
--stereo_method deeppruner \
--stereo_model_restore_path pretrained_models/DeepPruner/DeepPruner-best-kitti.tar \
--output_path perturb_models/deeppruner/di2fgsm/both_norm5e3_lr125e4_di5e1 \
--device gpu
...
--stereo_method deeppruner \
--stereo_model_restore_path pretrained_models/DeepPruner/DeepPruner-best-kitti.tar \
--output_path perturb_models/deeppruner/di2fgsm/both_norm2e3_lr5e5_di5e1 \
--device gpu